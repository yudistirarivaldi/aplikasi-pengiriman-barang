	...
	public function getTableMobil()
	{
		...
		else
		{
			foreach($data['data'] as $dt)
			{
				...
				$content .="<td><button type='button' class='btn btn-success btn-sm' href='#' onClick='pilih(&quot;".$dt['id_mobil']."&quot;,&quot;".$dt['plat']."&quot;,&quot;".$dt['jenis']."&quot;)' data-dismiss='modal'>pilih</button></td>";
	...
	public function getTableRate()
	{
		...
		else
		{
			foreach($data['data'] as $dt)
			{
				...
				$content .="<td><button type='button' class='btn btn-success btn-sm' href='#' onClick='pilih(&quot;".$dt['id_rate']."&quot;,&quot;".$dt['rate']."&quot;,&quot;".$dt['dari']."&quot;,&quot;".$dt['wilayah']."&quot;,&quot;".$dt['id_rate']."&quot;)' data-dismiss='modal'>pilih</button></td>";
		...
		$this->load->library('pagination');
		$config['base_url'] = site_url("ajax/getTableRate?");
		$config['total_rows'] = $total;
		$config['per_page'] = $limit;
		$config['query_string_segment'] = 'page';
		$config['use_page_numbers']  = TRUE;
