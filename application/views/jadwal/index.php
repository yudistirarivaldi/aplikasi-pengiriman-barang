					...
					<div class="box-header">
						<div class="filter-wrapper box-tools pull-right">
								<form class="form-inline" method="get" action="<?php echo site_url("jadwal")?>" >
									 ...
									 <a href="<?php echo site_url("jadwal/manage")?>" class="btn btn-success btn-sm">add</a>
								</form>
						</div>
					</div>
						...
						<?php foreach($data as $dt): ?>
						  <tr>
							<td><?php echo $dt['id_keberangkatan'];?></td>
							...
							<th>
								<a class="btn btn-warning btn-xs" href="<?php echo site_url("jadwal/manage")."/". $dt['id_keberangkatan']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
								<a class="btn btn-danger btn-xs" data-href="<?php echo site_url("jadwal/delete")."/". $dt['id_keberangkatan'];?>" data-toggle="modal" data-target="#confirm-delete" href="#"><span class="glyphicon glyphicon-remove"></span></a>
							</th>
						  </tr>
						<?php endforeach ?>
						</tbody>
