					...
					<form  class="form-horizontal" method="post" action="<?php echo site_url("pengiriman/save")?>" enctype="multipart/form-data">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" id="id_rate" placeholder="pilih rate" name="id_rate" value="<?php echo $data->id_rate; ?>" readonly  />
								</div>
							...
							<div class="form-group">
								<label for="rate" class="col-sm-2 control-label">Jenis Rate</label>
								<div class="col-sm-7">
