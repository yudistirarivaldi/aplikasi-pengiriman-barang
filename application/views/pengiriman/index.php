			...
			<div class="col-md-12">
				<div class="box box-primary">
					<div class="box-header">
						...
						<tbody>
						<?php
$usedIds = array(); // Array untuk menyimpan ID yang sudah muncul

foreach ($data as $dt) {
    $currentId = $dt['id_pengiriman'];

    // Periksa apakah ID sudah muncul sebelumnya
    if (in_array($currentId, $usedIds)) {
        // ID sudah muncul, lewati baris ini
        continue;
    }

    // ID belum muncul, tampilkan data dan tambahkan ID ke dalam array usedIds
    $usedIds[] = $currentId;
    ?>
    <tr>
    ...
    <?php endif; ?>
        ...
        <th>
            ...
            <a class="btn btn-primary btn-xs" target="blank" href="<?php echo site_url("pengiriman/invoice")."/". $dt['id_pengiriman']; ?>"><span class="glyphicon glyphicon-inbox"></span></a>
