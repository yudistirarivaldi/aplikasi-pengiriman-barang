	...
	<table>
		<tr>
			<td width='500' align="center" valign='top'>
				...
				<div class='header-pt'>PT. Massindo Solaris Nusantara </div>
				<div class='header-address'>Jl. Sudirman</div>
				<div class='header-address'>Banjarmasin</div>
				<div class='header-address'>Kalimantan Selatan, Indonesia</div>
			</td>
			<td valign='top' style="margin-left: 300px;">
