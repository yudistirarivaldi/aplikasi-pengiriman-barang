  ...
  <body class="hold-transition skin-blue layout-boxed sidebar-mini">
    <div class="wrapper">
      <header class="main-header">
        <!-- Logo -->
        <a href="" class="logo">
          <span class="logo-mini"><b>MSN</b></span>
          <span class="logo-lg"><b>PT MSN</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
				...
				<li ><a href="<?php echo site_url('rate')?>"><i class="fa fa-circle-o"></i> Rate</a></li>
				<li ><a href="<?php echo site_url('mobil')?>"><i class="fa fa-circle-o"></i> Mobil</a></li>
